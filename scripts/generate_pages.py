...
<header>
  <div class="header-top">
    <a class="brand" href="https://cossmology.com" target="_blank" rel="noopener">
      <div class="brand-text">
        <span class="brand-name">Cossmology</span>
        <span class="brand-sub">by Chinstrap Community</span>
      </div>
    </a>
    <div class="header-title">
      <h1>Awesome OSS Companies</h1>
      <p>A directory of commercial open source software (COSS) companies</p>
    </div>
